...
// 2. Tạo biến thủ môn và mảng cầu thủ cho Bayern Munich
const [gk, ...fieldPlayers] = players1;

// 3. Tạo mảng tất cả cầu thủ của cả hai đội
const allPlayers = [...players1, ...players2];

// 4. Tạo mảng cầu thủ cuối cùng của Bayern Munich sau khi thay người
const players1Final = [...players1, 'Thiago', 'Coutinho', 'Perisic'];

// 5. Tạo biến cho mỗi tỷ lệ cược
const {odds: {team1, x: draw, team2}} = game;

// 6. Hàm in ra tên cầu thủ và tổng số bàn thắng
function printGoals(...players) {
    console.log(`${players.length} bàn thắng được ghi bởi:`);
    players.forEach(player => console.log(player));
}

// 7. In ra đội có khả năng thắng cao hơn
console.log(`Đội có khả năng thắng cao hơn: ${team1 < team2 ? game.team1 : game.team2}`);

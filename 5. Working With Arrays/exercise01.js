...
function checkDogs(dogsJulia, dogsKate) {
    // 1. Tạo bản sao nông của mảng của Julia và loại bỏ tuổi mèo
    const dogsJuliaCorrected = dogsJulia.slice(1, -2);
    
    // 2. Tạo mảng mới kết hợp dữ liệu của Julia (đã sửa) và Kate
    const allDogs = dogsJuliaCorrected.concat(dogsKate);
    
    // 3. Kiểm tra và in kết quả cho từng con chó
